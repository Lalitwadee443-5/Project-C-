...
namespace PayrollSytem
{
    public partial class frm_Payroll : Form
    {
        ...
        private void calc_on_dedution()
        {
            try
            {
                double ca, pk, gt, d1, d2, d3, d4, total_deduction, gross, total_net;

                ca = double.Parse(txtpcadvance.Text);
                pk = double.Parse(txtpk.Text);
                gt = double.Parse(txtgt.Text);
                ...
                total_deduction = ca + pk + gt + d1 + d2 + d3 + d4;
        ...
        private void load_data()
        {
            sql = "SELECT DISTINCT (" +
             "p.`trans_id`" +
             "),e.emp_code as 'Assign Code', CONCAT(  `emp_fname` ,  ' ',  `emp_lname` ) AS  'Employee'" +
        ...
        private void btnPsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sql = "INSERT INTO  `payroll` " 
                    ...
                    + ", `cash_ad`, `bread_vale`, `pk`, `gt`, `net_income`, `remarks`,`dateissued`,trans_id)" 
                    ...
                    + "','" + txtpk.Text + "','" + txtgt.Text + "','" + txtpnetincome.Text 
